    ...
    <Dialog open={isModalOpen} onOpenChange={handleClose}>
        <DialogContent className="bg-white text-black overflow-auto">
            <DialogHeader className={"pt-5 px-6 text-center"}>
                ...
                <DialogDescription className=" text-zinc-900 text-md">Servers are organized into topic-based channels where you can collaborate, share, and just talk about your day without clogging up a group.</DialogDescription>
                {/* <Upload/> */}
                {!imageUploadUrl ?
                <UploadDropzone 
